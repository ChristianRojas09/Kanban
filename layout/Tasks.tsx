...
const Tasks: React.FC<{
  ...
  return (
    <div className="flex-1 h-full  p-6 flex gap-6 overflow-auto flex-nowrap bg-[#F2EFE5] dark:bg-[#35374B] border-t border-t-gray1 dark:border-t-black1">
      ...
      {board?.columns?.length > 0 && (
        <div className="bg-[#C7C8CC] dark:bg-black2 text-center mt-10 flex rounded-md">
          <h1
            onClick={() => dispatch(setActiveModal(ModalEnum.EDIT_BOARD))}
            className="text-gray3 w-[280px] my-auto cursor-pointer hover:text-[#B4B4B8] transition-colors"
          >
            + New Column
          </h1>
        </div>
